(function($, undefined) {
	jPlayerPlaylist = function(cssSelector, playlist, options) {
		...
		this.cssSelector.playlist = ".songs";
  ...
  timeDur = function(duration) {
    duration = parseInt(duration, 10) || 0;
    var minutes = Math.floor(duration / 60);
    var seconds = String(duration - minutes * 60);
    return String(minutes) + ':' + (seconds.length < 2 ? '0' + seconds : seconds);
  };
	...
	jPlayerPlaylist.prototype = {
		...
		_createListItem: function(media) {
			...
			listItem += "<span class='titles'>" + media.artist + " — " + media.title + "</span><span class='time'>" + timeDur(media.duration) + "</span>";
			listItem += "</li>";
		...
		_createItemHandlers: function() {
			...
			/*$(this.cssSelector.playlist).off("click", "span.titles").on("click", "span.titles", function() {
			...
			$(this.cssSelector.playlist).off("click", "a." + this.options.playlistOptions.freeItemClass).on("click", "a." + this.options.playlistOptions.freeItemClass, function() {
				$(this).parent().parent().find(".titles").click();
				$(this).blur();
				return false;
			});
		...
		_highlight: function(index) {
			if(this.playlist.length && index !== undefined) {
				...
				$(".track > .title").html(this.playlist[index].title);
				$(".track > .artist").html(this.playlist[index].artist);
			}
		},
		...
		add: function(media, playNow) {
			...
			$(this.cssSelector.playlist + " ul").append(this._createListItem(media)).find("li:first-child").hide().slideUp(this.options.playlistOptions.addTime);
